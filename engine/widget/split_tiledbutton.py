...
class SplitTiledButton(tiledbutton.TiledButton):
    ...
    def draw(self):
        ...
        pyray.draw_texture_pro(self.leftimage,pyray.Rectangle(0,0,self.leftimage.width,self.leftimage.height),pyray.Rectangle(pos_x + 5,pos_y + 5,self.width/2-10,self.height-10),pyray.Vector2(0,0),0,pyray.Color(255,255,255,255))
        pyray.draw_text(self.label,int(pos_x+self.width//2 + self.text_offset_x),int(pos_y + self.text_offset_y),self.fontsize,pyray.Color(128,128,128,255))
