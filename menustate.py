...
class MenuState(state.State):
    def __init__(self):
        ...
        self.play = button.Button(0, -100, 150, 40, "MC", self.play_action, "Play Game")
        self.options = button.Button(0, -50, 150, 40, "MC", self.options_action, "Options")
        self.credits = button.Button(0, 0, 150, 40, "MC", self.credits_action, "Credits")
        self.quit = button.Button(0, 50, 150, 40, "MC", self.quit_action, "Quit")
