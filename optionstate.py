...
class OptionState(state.State):
    def __init__(self):
        ...
        self.returntomenu = button.Button(0, 200, 250, 40, "MC", self.return_action, "Return to main menu")
        ...
        self.choice_key_left = button.Button(90, -50, 100, 40, "MC", self.newleftkey, chr(key.jkey_left))
        self.choice_key_right = button.Button(90, 0, 100, 40, "MC", self.newrightkey, chr(key.jkey_right))
        self.choice_key_action = button.Button(90, 50, 100, 40, "MC", self.newactionkey, chr(
